...
public class UpdateModel {
	...
	/**
	 * Constructs an {@link UpdateModel} on top of the given {@link Preferences} instance.
	 * 
	 * @param prefs a {@link Preferences} used to fetch and store update frequency configuration
	 */
	...
	/**
	 * Returns true if the update info must be updated according to the frequency, false otherwise.
	 * 
	 * @return true if the update info must be updated according to the frequency, false otherwise
	 */
	...
	public interface UpdateListener {
		 ...
		 * 
		 * @param newValue the new {@link Frequency} value
		 */
