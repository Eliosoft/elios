        ...
        if (httpExchange.getRequestMethod().equalsIgnoreCase("POST")) {
            ...
            try {
                ...
                if (additiveModeParam != null) {
                    boolean additiveMode = Boolean
                            .parseBoolean(additiveModeParam);
            ...
            String responseOk = "subnet=" + artNetServerManager.getSubnet()
                    + "&universe=" + artNetServerManager.getUniverse()
                    + "&additiveMode="
                    + artNetServerManager.isAdditiveModeEnabled();
            httpExchange.sendResponseHeaders(200, responseOk.length());
            httpExchange.getResponseBody().write(responseOk.getBytes());
            httpExchange.getResponseBody().close();
        } else {
